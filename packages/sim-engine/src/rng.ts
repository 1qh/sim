/** biome-ignore-all lint/suspicious/noBitwiseOperators: sfc32 bit-mix kernel */
/* oxlint-disable no-bitwise, unicorn/prefer-math-trunc, unicorn/number-literal-case */
