...
const StaticDatapathSvg = ({
  ...
  <svg
    ...
    />
    <path d='M462 461C470 461 470 451 462 451' stroke={wireStroke('RD2_JUMP')} strokeWidth={wireStrokeWidth('RD2_JUMP')} />
    <path
    ...
    />
    <path d='M447 304C455 304 455 294 447 294' stroke={wireStroke('SE_JUMP2')} strokeWidth={wireStrokeWidth('SE_JUMP2')} />
    <path
      d='M447 455.5V400.5'
    ...
    />
    <path d='M635 498C643 498 643 488 635 488' stroke={wireStroke('ALU_JUMP')} strokeWidth={wireStrokeWidth('ALU_JUMP')} />
    <path
...
export default StaticDatapathSvg
